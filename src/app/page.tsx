...
const LoadingPage = () => {
    ...
    }, [buttonClicked, intervalId, intervalDuration]);
                ...
                <div className="middle-portion">
                    ...
                    <div className="top-row">
                        <div className="present-time">
                            <div className="present-text">PRESENT TIME</div>
                        </div>
                    </div>
                    ...
                    <div className="middle-row">
                        <div className="mdy-text">
                            <div className="month-div">
                                <div id="m-text" className="m-text">
                                    {month}
                                </div>
                                <div className="m-bg-text">888</div>
                            </div>
                            <div className="date-div">
                                <div id="d-text" className="d-text">
                                    {date}
                                </div>
                                <div className="d-bg-text">88</div>
                            </div>
                            <div className="year-div">
                                <div id="y-text" className="y-text">
                                    {year}
                                </div>
                        ...
                        <div className="time-text">
                            <div className="hours-div">
                                <div id="h-text" className="h-text">
                                    {hours}
                                </div>
                            ...
                            <div className="min-div">
                                <div id="mi-text" className="mi-text">
                                    {minutes}
                                </div>
                    ...
                    <div className="pause-row">
                        <div className="press-button">
                            <button
                                id="press"
                                className={buttonClicked1 ? 'after' : 'press'}
                                onClick={handlePress}
                            >
